...
<head>
	...
	<script src="assets/js/jquery.forms.js"></script>
...
<tr>
	...
	<table cellspacing="0" cellpadding="0" border="0">
     ...
     <td valign=top class=normal>
				<div class=normal style="width:900;padding:15px 10px 15px 20px">
		<table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td class="header1">
<h3 class="page-header"> Cars Management   </h3>
...
{	
	SaveCarsDetails($_POST['carid'],$_POST['mileage'],$_POST['make'],$_POST['model'],$_POST['transmission'],$_POST['ChasisNumber'],$_POST['enginesize'],$_POST['yearManufactured'],$_POST['colour'],$_POST['arrivalDate'],$_POST['price'],$_POST['wheel'],$_POST['drive'],$_POST['fuel'],$_POST['seats'],$_POST['doors'],$_POST['carPictures']);
	...
	?>
	 ...
	 <option value="Diesel"> Diesel </option>
	  ...
	  <!--tr><td> Car Profile Picture: </td> <td> <input type="file" name="carPictures"  class='button'> </td></tr-->
		<tr><td> *  </td> <td><input type="text" id="imagelabel" name="carPictures" value="noimage.png" readonly />  </td><td> <img id="imagename" src="pics/noimage.png" /><br/> <br/><a id="uploadModalbtn" role="button" class="btn" data-toggle="modal">Upload Photo</a></td></tr>
...
{	
	...
	<table>
	<tr><td valign="top"> <img src="pics/<?php echo $recordsPlot['ProfilePicture']; ?>" height="300" width="400"> </td> <td>
...
{	
	...
	<img id="imagename" src="pics/<?php echo $recordsPlot['ProfilePicture']; ?>" height="300" width="400"> 
	<br/> <br/>
	<input type="text" id="imagelabel" name="carPictures" value="<?php echo $recordsPlot['ProfilePicture']; ?>" readonly />
	<br/> <br/><a id="uploadModalbtn" role="button" class="btn" data-toggle="modal">Upload Photo</a>
	</td> <td>
...
function SimpleSearchResults($make,$model,$transmission,$fuel,$drive)
{
	...
	if($count==false)
	{
		echo "<br/><div class='alert alert-warning center'>No Car Found </div>";
	}
	else
	{
		echo "<br/><div class='alert alert-success center'>".$count." car(s) Found </div>";
		?>
		...
		foreach($db->query($sql) as $record)
		{
			...
			<tr>
			<td> <?php echo $num; ?>. </td>
			<td> <img src="pics/<?php echo $record['ProfilePicture']; ?>" height="80" width="100"> </td>
	...
	<!-- Modal -->
			...
			aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-header">
					...
					<h3 id="myModalLabel">Car Image</h3>
				</div>
				<div class="modal-body">
					<form id="imageform" action="fileup.php" method="post"
